...
//			.matchesSafely(set), is(true));
	...
	public void testMatchesSafelyWithoutValues() throws Exception {
		...
		assertThat(arrayContaining(String.class).inAnyOrder().matchesSafely(set), is(true));
	}
	...
	public void testMatchesSafelyWithMatcher() throws Exception {
		...
		assertThat(arrayContaining(String.class, equalTo("bar"), "foo")
			.inAnyOrder()
			.matchesSafely(set), is(true));
		assertThat(arrayContaining(String.class, "bar", equalTo("foo"))
			.inAnyOrder()
			.matchesSafely(set), is(true));
	}
	...
	public void testMatchesSafelyWithNulls() throws Exception {
		...
		assertThat(arrayContaining(String.class, "foo", (String) null).inAnyOrder().matchesSafely(set), is(true));
		assertThat(arrayContaining(String.class, "foo", nullValue()).inAnyOrder().matchesSafely(set), is(true));
	}
